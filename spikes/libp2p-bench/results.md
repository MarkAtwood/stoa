...
- Protocol id: `/usenet-ipfs/bitswap/1.0.0`
...
bitswap codec and want-list implementation. For usenet-ipfs, where the primary
goal is RFC 3977 NNTP compatibility rather than bitswap protocol optimization,
this maintenance surface is a significant cost. See issue usenet-ipfs-l62.1.4
