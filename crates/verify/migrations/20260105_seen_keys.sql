...
CREATE TABLE IF NOT EXISTS seen_keys (
    ...
    key_data        BLOB    NOT NULL,  -- 32 raw bytes (ed25519) or DER (rsa)
    cert_der        BLOB,              -- reserved: X.509 DER for S/MIME (v2)
    first_seen_cid  BLOB    NOT NULL,  -- CID of first article this key signed
