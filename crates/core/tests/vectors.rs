...
fn serial_vector1_canonical_bytes() {
    ...
    let expected: &[u8] = &[
        ,
    ];

    assert_eq!(got, expected, "canonical bytes do not match Vector 1 reference");
}
...
fn sig_vector2_sign_article_canonical_bytes() {
    ...
    let ref_sig =
        ed25519_dalek::Signature::from_bytes(expected_sig_bytes.as_slice().try_into().unwrap());
    verify(&pubkey, &cbytes, &ref_sig)
        .expect("Sig Vector 2 must verify against known public key");
}
